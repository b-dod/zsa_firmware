...
combo_t key_combos[] = {
    ...
    [HC_UNDS] = COMBO(Hunds_combo, SK_UNDS), // _ underscore
...
//    [HC_AE] = COMBO_ACTION(HAE_lig_combo),  // Æ
    ...
    [PC_CENT] = COMBO_ACTION(PS7_combo), // ¢
    [PC_DOLR] = COMBO_ACTION(P78_combo), // $
    [PC_EURO] = COMBO_ACTION(P79_combo), // €
    [PC_BPND] = COMBO_ACTION(P89_combo), // £
    [PC_JYEN] = COMBO_ACTION(P9M_combo), // ¥
