...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [3] = LAYOUT_moonlander(
    ...
    KC_TRANSPARENT,        KC_LCTL,        KC_LALT,        KC_LGUI,        KC_LSFT, KC_TRANSPARENT, KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_TRANSPARENT,        KC_LEFT,        KC_DOWN,       KC_RIGHT, KC_TRANSPARENT, KC_TRANSPARENT, 
